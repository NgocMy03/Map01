...
<body>
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-1 p-2"
            ...
            <a id="select-sche" href="{{ route('logout') }}" title="Lịch làm việc"><i class="fa fa-sign-out"></i></a>
        </div>
                                ...
                                @foreach ($product as $prod)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('product.edit', $prod->id) }}" class="btn btn-success"><i
                                                    class="fa fa-edit"></i></a>
                                            <a href="{{ route('product.delete', $prod->id) }}"
